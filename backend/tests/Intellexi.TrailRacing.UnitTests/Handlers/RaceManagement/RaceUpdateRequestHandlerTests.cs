...
internal class RaceUpdateRequestHandlerTests : RaceUpdateRequestHandlerTestFixture
{
    ...
    {
        // Act
        Action action = () => new RaceUpdateRequestHandler(messageSender);
    ...
    public async Task Handle_ShouldHandleSuccessfully(RaceUpdateRequest request)
    {
        // Act
