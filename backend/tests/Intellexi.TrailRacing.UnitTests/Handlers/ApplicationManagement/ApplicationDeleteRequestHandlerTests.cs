...
internal class ApplicationDeleteRequestHandlerTests : ApplicationDeleteRequestHandlerTestFixture
{
    ...
    {
        // Act
        Action action = () => new ApplicationDeleteRequestHandler(messageSender);
    ...
    public async Task Handle_ShouldHandleSuccessfully(ApplicationDeleteRequest request)
    {
        // Act
